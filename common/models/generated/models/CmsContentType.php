 ...
 *
    ...
    */
class CmsContentType extends \common\ActiveRecord
{
    ...
    */
    ...
    {
        return $this->hasMany($this->called_class_namespace . '\CmsContent', ['content_type' => 'code']);
    }
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \common\models\query\CmsContentTypeQuery the active query used by this AR class.
    */
    public static function find()
    {
        return new \common\models\query\CmsContentTypeQuery(get_called_class());
    }
}
