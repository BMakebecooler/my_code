 ...
 *
    ...
    */
class CmsContentElementImage extends \common\ActiveRecord
{
    ...
    */
    ...
    {
        return [
            [['created_by', 'updated_by', 'created_at', 'updated_at', 'storage_file_id', 'content_element_id', 'priority', 'bitrix_id'], 'integer'],
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \common\models\query\CmsContentElementImageQuery the active query used by this AR class.
    */
    public static function find()
    {
        return new \common\models\query\CmsContentElementImageQuery(get_called_class());
    }
}
