...
/**
 * This is the model class for table "cms_user_property".
 *
 ...
 *
     ...
     * @property CmsUser $element
     * @property CmsUserUniversalProperty $property
     * @property CmsUser $updatedBy
    */
class CmsUserProperty extends \common\ActiveRecord
{
    ...
    */
    public function rules()
    {
        return [
            ...
            [['element_id'], 'exist', 'skipOnError' => true, 'targetClass' => CmsUser::className(), 'targetAttribute' => ['element_id' => 'id']],
    ...
    */
    ...
    {
        return $this->hasOne($this->called_class_namespace . '\CmsUser', ['id' => 'element_id']);
    }
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \common\models\query\CmsUserPropertyQuery the active query used by this AR class.
    */
    public static function find()
    {
        return new \common\models\query\CmsUserPropertyQuery(get_called_class());
    }
}
