 ...
 * @property string $value_num2 Value Num2
 * @property integer $value_int2 Value Int2
 * @property string $value_string Value String
 *
    ...
    */
class Form2FormSendProperty extends \common\ActiveRecord
{
    ...
    */
    ...
    {
        return [
            [['created_by', 'updated_by', 'created_at', 'updated_at', 'property_id', 'element_id', 'value_enum', 'value_bool', 'value_int2'], 'integer'],
            [['element_id', 'value'], 'required'],
            [['value'], 'string'],
            [['value_num', 'value_num2'], 'number'],
            [['description', 'value_string'], 'string', 'max' => 255],
            [['created_by'], 'exist', 'skipOnError' => true, 'targetClass' => CmsUser::className(), 'targetAttribute' => ['created_by' => 'id']],
            [['element_id'], 'exist', 'skipOnError' => true, 'targetClass' => Form2FormSend::className(), 'targetAttribute' => ['element_id' => 'id']],
    ...
    */
    public function attributeLabels()
    {
        return [
            ...
            'value_num2' => 'Value Num2',
            'value_int2' => 'Value Int2',
    ...
    */
    ...
    {
        return $this->hasOne($this->called_class_namespace . '\Form2FormSend', ['id' => 'element_id']);
    }
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \common\models\query\Form2FormSendPropertyQuery the active query used by this AR class.
    */
    public static function find()
    {
        return new \common\models\query\Form2FormSendPropertyQuery(get_called_class());
    }
}
