 ...
 *
    ...
    */
class CmsContentElementProperty extends \common\ActiveRecord
{
    ...
    */
    public function rules()
    {
        return [
            ...
            [['property_id'], 'exist', 'skipOnError' => true, 'targetClass' => CmsContentProperty::className(), 'targetAttribute' => ['property_id' => 'id']],
    ...
    */
    ...
    {
        return $this->hasOne($this->called_class_namespace . '\CmsContentProperty', ['id' => 'property_id']);
    }
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \common\models\query\CmsContentElementPropertyQuery the active query used by this AR class.
    */
    public static function find()
    {
        return new \common\models\query\CmsContentElementPropertyQuery(get_called_class());
    }
}
