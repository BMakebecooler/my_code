...
//    public $offset2 = [125, 174];
    ...
    public $offset1 = [600, 605];
    public $offset2 = [675, 160];
    ...
    protected function _save()
    {
        ...
        $price2 = '-'. $shopProduct->badgeDiscount() . '%';
