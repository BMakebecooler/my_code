<?php
namespace common\components\gtmetrix;
...
use modules\shopandshow\models\test\GTMetrix;

class ServicesWTFTest
{
     ...
     * $isSaveDb    string  password/apikey to log in with
     */
    public function __construct($username = '', $password = '', $isSaveDb = false)
    {
    ...
    {
        return GTMetrix::add($this->result['results'], $this->url, $this->test_id);
    }
