    ...
    <tr>
        <td>
            ...
            <table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
                ...
                <tr>
                    <td>
                        <a href='<?= $template->getResponseLink($data['image1']['URL']); ?>'
                           style="display: block;">
                            <img style="display: block;" alt="" width="750" border="0"
                                 src="<?= $template->makeAbsUrl($data['image1']['IMG']); ?>">
                        </a>
                    </td>
                </tr>
            ...
            <table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
                ...
                <tr>
                    <td style="line-height: normal; text-align: center; padding-bottom: 15px" colspan="3">
                        <p style="font: 16px/24px Arial, sans-serif; margin: 0; padding: 10px 20px; color: #A0456C;">
                            6,7 и 8 октября - в прямом эфире телеканала Shop&Show вас ждут сюрпризы, подарки и самые
                            необычные ведущие рубрик - звёздные гости, не пропустите!
                        </p>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <a href='<?= $template->getResponseLink($data['image2']['URL']); ?>'
                           style="display: block;">
                            <img style="display: block;" alt="" width="750" border="0"
                                 src="<?= $template->makeAbsUrl($data['image2']['IMG']); ?>">
                        </a>
                    </td>
                </tr>
            ...
            <table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
                ...
                <tr>
                    <td>
                        <a href='<?= $template->getResponseLink($data['image3']['URL']); ?>'
                           style="display: block;">
                            <img style="display: block;" alt="" width="750" border="0"
                                 src="<?= $template->makeAbsUrl($data['image3']['IMG']); ?>">
                        </a>
                    </td>
                </tr>
                </tbody>
