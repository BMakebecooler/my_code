...
<?= $this->render('_forms/_form-main', [
    'form' => $form,
    'contentModel' => $contentModel,
    'model' => $model,
]); ?>

<?= $this->render('_forms/_form-property', [
    'form' => $form,
    'contentModel' => $contentModel,
    'model' => $model,
]); ?>
...
<? if (false): ?>
    ...
    <? if (false && $shopContent->childrenContent) : ?>
        <?
...
JS
    ...
    <div id="sx-shop-product-simple">
        ...
        <? if ($productPrices) : ?>
            <?
//            echo  \skeeks\cms\modules\admin\widgets\BlockTitleWidget::widget([
...
<? if (false && $shopContent->childrenContent && $model->cmsContent->getChildrenContents()->andWhere(['!=', 'id', $shopContent->childrenContent->id])->all()) : ?>
