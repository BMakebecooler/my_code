...
<div class="well">
		Найдено заказов: <span class="label label-primary" style="font-size: 14px;"><?= $dataProvider->totalCount; ?></span> на сумму <span class="label label-primary" style="font-size: 14px;"><?= \Yii::$app->formatter->asDecimal($searchModel->getTotalPrice($dataProvider)); ?> руб.</span>
</div>
...
HTML;
        ...
        [
            ...
            'attribute' => 'source',
            'value' => function($row){
                return ShopOrder::getSourceLabel($row['source']);
            },
            'filter' => array_map(
                function($source){
        ...
        [
            ...
            'value' => function($row){
                return ShopOrder::getSourceDetailLabel($row['source_detail']);
            },
            'filter' => array_map(
                function($source){
