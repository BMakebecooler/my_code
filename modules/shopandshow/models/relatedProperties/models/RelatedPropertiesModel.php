...
namespace modules\shopandshow\models\relatedProperties\models;

use common\helpers\ArrayHelper;
use Exception;
use modules\shopandshow\models\common\form\RelatedPropertyModel;
use skeeks\cms\relatedProperties\models\RelatedElementModel;
use skeeks\cms\relatedProperties\models\RelatedPropertiesModel as SXRelatedPropertiesModel;
...
class RelatedPropertiesModel extends DynamicModel
{
    ...
    public $relatedPropertiesName = 'relatedProperties';
    ...
    public function init()
    {
        ...
        if ($this->relatedElementModel->{$this->relatedPropertiesName}) {
            foreach ($this->relatedElementModel->{$this->relatedPropertiesName} as $property) {
