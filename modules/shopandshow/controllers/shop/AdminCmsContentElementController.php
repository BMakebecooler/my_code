...
/*                "rp" =>
                ...
                "export" =>
                    [
                        'class' => AdminMultiModelEditAction::className(),
                        "name"  => 'Экспорт в экесель',
                        "icon"              => "glyphicon glyphicon-share",
//                        "eachCallback" => [$this, 'eachExport'],
                    ],
            ]
        );
    ...
    public function exportAction(AdminAction $adminAction){
    }
    ...
    public function update(AdminAction $adminAction)
    {
        ...
        {
            if (false && $typePrices = ShopTypePrice::find()->where(['!=', 'def', Cms::BOOL_Y])->all())
            {
